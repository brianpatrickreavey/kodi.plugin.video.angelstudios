...
2. **Phase 0 changes** (refactoring): Ensure tests don't change behavior (they verify behavior)
...
After Phase 0, **code review checklist:**
...
- [x] 0.1 – Remove unused imports (3 files)
  - [x] kodi_ui_interface.py
  - [x] angel_interface.py
  - [x] angel_authentication.py
  - [x] Tests pass; pyright/flake8 clean
- [x] 0.2 – Remove duplicate imports (tests)
  - [x] test_kodi_ui_interface_menus.py
- [x] 0.3 – Extract cache TTL constants
  - [x] kodi_ui_interface.py (module-level constants)
  - [x] Update all hardcoded TTLs
  - [x] Tests pass
- [x] 0.4 – Archive research docs
  - [x] Create `docs/archive/`
  - [x] Move 5 docs
  - [x] Add README
- [x] 0.5 – Verify relative imports
  - [x] All internal lib imports are relative
  - [x] No circular dependencies
  - [x] pyright clean
- [x] 0.6 – Verify angel_interface.py and angel_authentication.py are KODI-agnostic
  - [x] Zero xbmc imports in both files
  - [x] Zero SimpleCache usage in both files
  - [x] Pure Python import check for both
...
- [x] **Phase 0 Complete**: Run `make unittest-with-coverage` → expect coverage maintained or improved
- [x] **Phase 0 Complete**: Run `make lint` → expect targeted errors resolved
...
**Before Commit:**
- [x] All phases complete (0)
- [x] `make unittest-with-coverage` → expect coverage maintained or improved
- [x] `make format-and-lint` → zero errors
- [x] Code review approved
- [x] Docs updated/archived
- [x] .gitignore updated
- [x] Makefile targets added
- [x] pytest.ini created
- [x] .flake8 config created
- [x] Timing baseline captured
...
[... continue for each 0.x ...]

Phase 0.7: feat: cleanup 0.7 - resolve pyright type checking issues
...
**Document Status:** Complete for Phase 0
**Next Step:** Proceed to Phase 1 (see CLEANUP - Phase 1.md)