...
MOCK_PROJECTS_DATA = {
    'movies': [
        {'slug': 'test_movie_project', 'name': 'Test Movie Name', 'projectType': 'movie'}
    ],
    'series': [
        {'slug': 'test_series_project', 'name': 'Test Series Name', 'projectType': 'series'}
    ],
    'specials': [
        {'slug': 'test_special_project', 'name': 'Test Special Name', 'projectType': 'special'}
    ]
}
        ...
        'seasons': [
            {
                ...
                'name': 'Season 1',
                'episodes': [
                    {'id': 1, 'name': 'Season 1 Episode 1', 'seasonNumber': 1, 'guid': 's1ep1-guid', 'source': {'url': 'http://example.com/s1ep1.mp4'}},
                    {'id': 2, 'name': 'Season 1 Episode 2', 'seasonNumber': 1, 'guid': 's1ep2-guid', 'source': {'url': 'http://example.com/s1ep2.mp4'}}
                    ]
            },
            {
                ...
                'name': 'Season 2',
                'episodes': [
                    {'id': 1, 'name': 'Season 2 Episode 1', 'seasonNumber': 2, 'guid': 's2ep1-guid', 'source': {'url': 'http://example.com/s2ep1.mp4'}},
                    {'id': 2, 'name': 'Season 2 Episode 2', 'seasonNumber': 2, 'guid': 's2ep2-guid', 'source': {'url': 'http://example.com/s2ep2.mp4'}}
                ]
            }
        ]
    },
        ...
        'seasons': [
            {
                ...
                'name': 'All Episodes',
                'episodes': [
                    {'id': 1, 'name': 'Special Episode 1', 'guid': 'spec-ep1-guid', 'source': {'url': 'http://example.com/spec-ep1.mp4'}},
                    {'id': 2, 'name': 'Special Episode 2', 'guid': 'spec-ep2-guid', 'source': {'url': 'http://example.com/spec-ep2.mp4'}}
                ]
            }
        ]
    }
...
MOCK_EPISODE_DATA = {
    'episode': {
        ...
        'subtitle': 'Episode Subtitle 1',
        'source': {
            'url': 'http://example.com/episode1.mp4'
        },
